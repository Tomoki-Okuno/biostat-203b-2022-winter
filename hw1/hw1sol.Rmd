...
**Solution:**
    ...
    last | head
    ```
    - `who am i` displays information about the current terminal, such as username, console, and log-in time. However, the output is not displayed on a teaching server maybe because the process is ongoing.
