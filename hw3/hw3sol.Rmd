...
# only keep the patients for the first ICU stay
...
**Solution:** My app (app.R) was resided in the `mimiciv_shiny` folder. I made two types of summaries: using 30-day mortality as an indicator (like HW2) and not.
