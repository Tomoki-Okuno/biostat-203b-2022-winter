...
**Solution:** The following code made `labevents_tble` 52,544 rows. I used `select` to keep `subject_id` and ten lab measurements, or only 11 columns.
```{r}
...
**Solution:** I ran almost the same code as Q5-3 and obtained a tibble with 53,150 × 6, which consists of only `subject_id` and five vital measurements.
```{r}
...
**Brief comment:** The proportion of CVICU for patients who died within 30 days is 14 points smaller than that of those who did not. On the other hand, for MICU, the proportion of patients who died within 30 days is 9 points higher. Other than that, there appears to be little difference.