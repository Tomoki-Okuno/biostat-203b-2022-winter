...
### Completeness, correctness and efficiency of solution: 140/100

- Q1 (60/60) Imputation

- Q2 (80/40) Predictive modeling

### Usage of Git: 5/10

-   Are branches (`master` and `develop`) correctly set up? Is the hw submission put into the `master` branch?

    No. There is no rproject file for me to load into. `-5`.
